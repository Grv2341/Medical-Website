...
<body>
	...
	<div id="body">
		...
		<button onclick="document.location.href='patient1.php'" style="padding:10px 0 10px 0;width:200px;border:none;border-radius: 20px;background:rgb(246,141,45);color:white;font-size: 20px;"><img src="add.png" style="width:20px;height:20px;vertical-align:text-bottom;margin-right: 10px;">Load All</button>
		</div>
		</div>
	</div>
</body>
